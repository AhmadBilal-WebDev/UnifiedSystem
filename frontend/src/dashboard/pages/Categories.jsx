...
function BannerUploader({ value, onChange }) {
  ...
  const handleFile = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/api/upload?type=categories`, {
        method: "POST",
        body: formData,
      });
...
export default function Categories() {
  ...
  const openAdd = () => {
    ...
    setForm({
      ...
      icon: "",
      color: "#f97316",
      sortOrder: String(categoryList.length + 1),
      active: true,
      bannerImg: "",
      applyToAllBranches: false,
    });
    ...
    <div className="page-content">
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 12, color: "var(--text-m)", marginTop: 2 }}>
            {categoryList.filter((c) => c.active).length} active ·{" "}
      ...
      <div className="grid3">
        {[...categoryList]
          ...
          .map((c, i) => {
            const bannerSrc =
              c.bannerImg && c.bannerImg.startsWith("http")
                ? c.bannerImg
                : c.bannerImg
                  ? `${API_BASE}${c.bannerImg}`
                  : null;
            return (
              <div
                key={c.id}
              ...
              >
                ...
                <div style={{ padding: 14 }}>
                  ...
                  >
                    ...
                    <span
                      className={`badge badge-${c.active ? "green" : "gray"}`}
                    >
                      {c.active ? "Active" : "Off"}
                    </span>
                  </div>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <BannerUploader
              ...
              onChange={(v) => setForm((f) => ({ ...f, bannerImg: v }))}
            />
            <div>
              <div
                style={{
              ...
              <div className="grid-form-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Limit ">Limited Edition</option>
                    <option value="New ">New Arrival</option>
                    <option value="Best ">Best Seller</option>
                    <option value="Offer">Discounted</option>
                  </select>
                </div>
              </div>
                ...
                <div>
                  ...
                  >
                    {form.applyToAllBranches
                      ? "This category will appear on every branch."
                      : "This category will only appear on your current branch."}
                  </div>
                </div>
